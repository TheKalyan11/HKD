  ...
  return (
    <main className="min-h-screen bg-[#FAFAFA] text-[#0A0A0A] font-sans selection:bg-[#0A0A0A] selection:text-white relative z-0">
            ...
            <div>
              ...
              <div className="space-y-4 mb-10">
                <blockquote className="border-l-4 border-[#1A82D6] pl-5 py-1 italic text-gray-600 font-light bg-gray-50 rounded-r-lg">
                  “One who gives food, gives all that is worth giving in this world.”<br/>
                  <span className="text-sm font-medium not-italic mt-2 block text-[#0A0A0A]">- Varaha Purana</span>
                </blockquote>
                <blockquote className="border-l-4 border-[#1A82D6] pl-5 py-1 italic text-gray-600 font-light bg-gray-50 rounded-r-lg">
                  “Do not send away anyone who comes to your door, without offering him food and hospitality.”<br/>
                  <span className="text-sm font-medium not-italic mt-2 block text-[#0A0A0A]">- Taittriya Upanishad</span>
                </blockquote>
              </div>
      ...
      <section className="py-10 pb-32 px-6 sm:px-10 max-w-[1440px] mx-auto">
        <h2 className="text-3xl font-medium tracking-tight mb-10 text-center">Glimpses of Annadana Seva</h2>
